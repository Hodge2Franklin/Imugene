...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const shareButton = document.querySelector('button:nth-of-type(1)');
    if (shareButton) {
    ...
    const exportButton = document.querySelector('button:nth-of-type(2)');
    if (exportButton) {
    ...
    const timeframeButton = document.querySelector('button:nth-of-type(3)');
    if (timeframeButton) {
            ...
            if (!dropdown) {
                ...
                options.forEach(option => {
                    ...
                    item.addEventListener('click', function() {
                        timeframeButton.innerHTML = `<i class="fas fa-calendar-week"></i> ${option}`;
                        dropdown.style.display = 'none';
