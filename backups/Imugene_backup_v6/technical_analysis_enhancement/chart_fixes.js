// Fix for Scenario Builder Chart
document.addEventListener('DOMContentLoaded', function() {
    // Check if the scenario-builder element exists
    if (document.getElementById('scenario-builder')) {
        ...
        console.error('Scenario builder container not found');
    }
});

// Fix for Predictive Modeling Chart
document.addEventListener('DOMContentLoaded', function() {
